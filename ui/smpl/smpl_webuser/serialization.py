...
def ready_arguments_smplx(fname_or_dict):
...
def load_smplx_model(fname_or_dict):
    dd = ready_arguments_smplx(fname_or_dict)
...
def load_flame_model(fname_or_dict):
    dd = ready_arguments(fname_or_dict)
